-file("/usr/local/Cellar/erlang/20.3.2/lib/erlang/lib/parsetools-2.1.6/include/leexinc.hrl", 0).
...
-file("/usr/local/Cellar/erlang/20.3.2/lib/erlang/lib/parsetools-2.1.6/include/leexinc.hrl", 14).
...
yystate(6, [10|Ics], Line, Tlen, _, _) ->
    yystate(6, Ics, Line+1, Tlen+1, 5, Tlen);
...
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(2, Ics, Line, Tlen+1, 3, Tlen);
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 35 ->
    yystate(2, Ics, Line, Tlen+1, 3, Tlen);
...
-file("/usr/local/Cellar/erlang/20.3.2/lib/erlang/lib/parsetools-2.1.6/include/leexinc.hrl", 313).
